...
namespace simpleP2P {
	RequestServerModule::RequestServerModule(boost::asio::ip::address my_ip_, Uint16 port_, FileManager& fm, LoggingModule& lm)
		: my_ip(my_ip_), port(port_), file_manager(fm), logging_module(lm)
	{}
