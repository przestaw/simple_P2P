 ...
 *
 * Receives the file request, buffers requested segments and sends them to the
 * client.
 */
class RequestWorker
...
public:
  /**
   * Constructor allows setting the socket on which the connection is
   * established
   *
...
private:
  static const Uint16 MAX_RECV_DATA_LENGHT =
      300; //!< Maximum data that can be read via TCP.
